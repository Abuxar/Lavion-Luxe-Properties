...
There is no featured partner. Lavion Luxe Properties was pinned above the other
agents here until it moved to a site of its own; the card, the profile page and
the house-agency seed were removed, and `/:market/partner` redirects to the
market page.
